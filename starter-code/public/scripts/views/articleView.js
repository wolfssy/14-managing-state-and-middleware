...
(function(module) {
  ...
  // This figures out how many days ago an article was written and then puts that into publishStatus then renders it to the handlebars template in the html.
